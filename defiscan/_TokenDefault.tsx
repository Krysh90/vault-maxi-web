  ...
  function TokenDefaultSymbol(props: SVGProps<SVGSVGElement>): JSX.Element {
    return (
      <svg width="1em" height="1em" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        />
        <defs>
          <linearGradient id="paint0_linear_58_4012" x1="0" y1="24" x2="48" y2="24" gradientUnits="userSpaceOnUse">
  ...
  function PoolPairTokenSymbol(props: SVGProps<SVGSVGElement>): JSX.Element {
    return (
      <svg width="1em" height="1em" viewBox="0 0 32 32" {...props}>
        <path fill="#000000" d="M16 0C7.163 0 0 7.163 0 16s7.163 16 16 16c8.838 0 16-7.163 16-16S24.838 0 16 0z" />
        <text
          className="pointer-events-none"
          fill="white"
          fontSize="9"
